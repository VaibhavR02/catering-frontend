...
export default function Login() {
  ...
  const [email, setEmail]       = useState('user@tiffin.com')
    ...
    <div className="login-page">
      ...
      <div className="login-visual">
        ...
        <div className="login-brand">
          ...
          <h1 className="login-headline">
            Society-wise<br />tiffin, <em>managed</em><br />brilliantly.
          </h1>
      ...
      <div className="login-panel">
        <div className="login-form-wrap">
          ...
          <p className="login-form-sub">Choose your role and enter your credentials</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{
              ...
              borderRadius: 'var(--radius-sm)', padding: '10px 12px', marginBottom: 20,
              fontSize: 11.5, color: 'var(--text-muted)',
              fontFamily: 'var(--font-mono)', lineHeight: 1.7
            }}>
              <span style={{ color: 'var(--ember)', fontWeight: 700 }}>DEMO</span>
              {'  '}pw: <span style={{ color: 'var(--text-secondary)' }}>123456</span>
              {'  '}•{'  '}
              {selectedRole === 'user' && 'user@tiffin.com'}
              {selectedRole === 'vendor_admin' && 'vendor@tiffin.com'}
              {selectedRole === 'master_admin' && 'admin@tiffin.com'}
            </div>
          ...
          <div style={{ marginTop: 28, padding: '16px 0', borderTop: '1px solid var(--border-subtle)' }}>
